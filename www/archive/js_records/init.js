...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Row Click (Delegated) - OLD PANEL BEHAVIOR
    // NOTE: Disabled - now using InlineEdit for in-cell editing
    // if (DOM.tableBody) {
    ...
    // ARCHIVED: InlineEdit module moved to archive/
    // if (typeof BGL.InlineEdit !== 'undefined') {
    //     BGL.InlineEdit.init();
    // }
    ...
    // 3. Initial Load
    // ARCHIVED: Overlay module moved to archive/
