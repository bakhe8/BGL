...
## 🚧 المميزات المخططة (Planned Features - Phase 6)

### 1. تحديد نية الخطاب (Letter Purpose Selector)
سيتم إضافة قائمة منسدلة في "قسم البيانات العلوية" (Data Section) تسمح للمستخدم بتحديد الغرض من الخطاب:
- **تمديد (Extension)** - *الافتراضي*
- **إفراج (Release)**
- **تخفيض (Reduction)**
- **مصادقة (Confirm)**

هذا الاختيار سيتحكم **تلقائياً** في نص المعاينة (Preview) في الأسفل.
